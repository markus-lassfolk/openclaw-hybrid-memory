...
|---|---|---|
| `verify` fails on DB/embeddings/cron | `openclaw hybrid-mem verify --json` then `verify --fix` | [`../extensions/memory-hybrid/cli/verify/sections/infrastructure.ts`](../extensions/memory-hybrid/cli/verify/sections/infrastructure.ts), [`../extensions/memory-hybrid/cli/verify/sections/embeddings.ts`](../extensions/memory-hybrid/cli/verify/sections/embeddings.ts), [`../extensions/memory-hybrid/cli/verify/sections/config-cron.ts`](../extensions/memory-hybrid/cli/verify/sections/config-cron.ts) |
