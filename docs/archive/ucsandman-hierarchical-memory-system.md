...
**Source:** [ucsandman/OpenClaw-Hierarchical-Memory-System](https://github.com/ucsandman/OpenClaw-Hierarchical-Memory-System) (GitHub)  
**Author:** ucsandman  
**Captured:** 2026-02-15  

*Copy and paste the content below to your OpenClaw agent on Opus 4.6 (or use as a reference).*
...
| Scenario        | Old (flat) | New (hierarchical)     |
|----------------|------------|-------------------------|
| Session start   | 5-10k      | ~1.5k (index only)      |
| + 1 drill-down  | —          | ~2-3k total              |
| + Active Context| —          | ~3-4k total              |
| Full load       | 15-20k     | ~5-6k                   |
