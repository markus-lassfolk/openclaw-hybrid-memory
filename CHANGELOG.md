...
### Deferred (fresh sweep, loop iteration 103 — remaining items, ranked by severity; the search-scope, cmd-store-duplicate-check, stage-recall.ts, and cmd-selfcorrection.ts merge-reembed items previously listed here were fixed in v2026.7.174, v2026.7.176, v2026.7.177, and v2026.7.178 respectively and are no longer tracked)
