...
### Deferred (fresh sweep, loop iteration 103 — remaining items, ranked by severity; the search-scope, cmd-store-duplicate-check, stage-recall.ts, cmd-selfcorrection.ts merge-reembed, and reconcile.ts SQLite-orphan items previously listed here were fixed in v2026.7.174, v2026.7.176, v2026.7.177, v2026.7.178, and v2026.7.179 respectively and are no longer tracked)
