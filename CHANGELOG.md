...
### Deferred (fresh sweep, loop iteration 103 — remaining items, ranked by severity; the search-scope, cmd-store-duplicate-check, and stage-recall.ts items previously listed here were fixed in v2026.7.174, v2026.7.176, and v2026.7.177 respectively and are no longer tracked)
