...
### Deferred (fresh sweep, loop iteration 103 — remaining items, ranked by severity; the search-scope, cmd-store-duplicate-check, stage-recall.ts, cmd-selfcorrection.ts merge-reembed, reconcile.ts SQLite-orphan, install-index-reconcile.ts unreadable-version, and wal.ts rewrite-lock items previously listed here were fixed in v2026.7.174, v2026.7.176, v2026.7.177, v2026.7.178, v2026.7.179, v2026.7.180, and v2026.7.181 respectively and are no longer tracked)
