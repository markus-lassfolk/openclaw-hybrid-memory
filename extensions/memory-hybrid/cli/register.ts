...
export type HybridMemCliContext = {
	...
	runDreamCycle: () => Promise<
		import("../services/dream-cycle.js").DreamCycleResult
	>;
	runContinuousVerification: () => Promise<
	...
	listCommands?: {
		...
		listCorrections: (opts: {
			workspace?: string;
		}) => Promise<{ reportPath: string | null; items: string[] }>;
		correctionsApproveAll: (opts: {
			workspace?: string;
	...
	runBackup?: (opts?: {
		backupDir?: string;
	}) => Promise<import("../cli/backup.js").BackupCliResult>;
