...
export function registerDistillCommands(mem: Chainable, ctx: DistillContext): void {
  ...
  mem
    ...
    .option("--model <model>", "LLM for extraction (recommended: gemini-3.1-pro-preview for 1M context). Default: config.distill.defaultModel or gemini-3.1-pro-preview")
  ...
  mem
    ...
    .action(withExit(async (opts: { dryRun?: boolean; apply?: boolean; days?: string; verbose?: boolean }) => {
