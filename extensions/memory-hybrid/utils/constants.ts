...
export const ACTION_VERB_PATTERN =
  /\b(?:use|run|create|fix|validate|apply|checks?|install|deploy(?:ment)?|open|read|write|execute|verify|follow|review|summari[sz]e|analyse|analyze|test|investigate)\b/i;
