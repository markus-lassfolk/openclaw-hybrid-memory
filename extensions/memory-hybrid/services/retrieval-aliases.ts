...
export async function storeAliases(
  ...
  // Delete any existing aliases for this fact before inserting fresh ones,
  // making alias generation idempotent and bounding the table to maxAliases rows per fact.
