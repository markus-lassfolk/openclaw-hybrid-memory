...
export type CronJobMessageEntry = {
	id: string;
	text: string;
	enabled: boolean;
};
...
export function extractCronJobMessageEntries(
	store: { jobs?: unknown[] } | null | undefined,
): CronJobMessageEntry[] {
...
export function textMatchesAnyHeartbeatPattern(
	matchers: RegExp[],
	userText: string,
): boolean {
...
export function getHeartbeatMatchersForVerify(
