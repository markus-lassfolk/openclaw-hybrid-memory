...
export function getModeCostEstimates(): ModeEstimate[] {
	return [
		...
		},
		{
			mode: "minimal",
			description:
				"Nano for classify, flash for distill — good value at low cost",
			features: [
				"embeddings",
				"auto-classify",
				"distill",
		...
		},
		{
			mode: "enhanced",
			description:
				"Reflection, self-correction, entity lookup, classify-at-write",
			features: [
				"embeddings",
				"auto-classify",
				"structured-recall",
		...
		},
		{
			mode: "complete",
			description:
				"Everything — query expansion, ingest, dream-cycle, extract-daily",
			features: [
				"embeddings",
				"auto-classify",
				"query-expansion",
