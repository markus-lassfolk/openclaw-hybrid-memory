...
export const DEFAULT_AUTH_FAILURE_PATTERNS: AuthFailurePattern[] = [
	...
	{
		regex: /publickey,password/i,
		type: "ssh",
		hint: "SSH auth methods exhausted",
	},
	{
		regex: /Host key verification failed/i,
		type: "ssh",
		hint: "SSH host key verification failed",
	},
	...
	{
		regex: /authentication.*(required|failed)/i,
		type: "api",
		hint: "Authentication required/failed",
	},
	{
		regex: /invalid.*(credentials|token|key)/i,
		type: "api",
 ...
 */
export function buildCredentialQuery(
