...
export const AGENT_TOOL_CONTRACT_NAMES = [
  ...
  "credential_get",
  "credential_list",
  "credential_revision_get",
  "credential_revision_list",
  "credential_revision_pin",
  "credential_revision_purge",
  "credential_revision_restore",
  "credential_store",
  "diary_read",
  "diary_write",
  "goal_abandon",
