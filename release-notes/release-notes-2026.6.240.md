# Release notes — OpenClaw Hybrid Memory **2026.6.240**

**Release date:** 2026-06-24  
**Since:** [2026.6.171](CHANGELOG.md#20266171---2026-06-21)  
**Full changelog:** [CHANGELOG.md](../CHANGELOG.md) — section **[2026.6.240]**
...
Also clears the full-tree TypeScript error backlog so `tsc --noEmit` is green in CI again.
...
- Resolved full-tree `tsc --noEmit` errors across the package (CLI, services, tools, tests).
